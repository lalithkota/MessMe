...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT >= 23){
            if( (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) && (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)){
                ActivityCompat.requestPermissions(MainActivity.this,new String[]{Manifest.permission.RECORD_AUDIO,Manifest.permission.CAMERA}, MY_PERMISSION_REQUEST);
            }
        }
    ...
    public void askForIP(){
        ...
        LayoutInflater lf = getLayoutInflater();
        View view = lf.inflate(R.layout.dialog_ip,null);
        ((EditText)view.findViewById(R.id.ip_id_new1)).setHint("Server <IP:PORT>");
    ...
    //for context menu for each entry
    @Override
